    ...
    <div class="featuredEvents__wrapper">
        ...
        <div class="featuredEvents__slide">
            <figure class="featuredEvents__fig">
                <img class="featuredEvents__img" src="{{ asset('storage/' . $event->img) }}" alt="{{ $event->title }}">
            </figure>
            <div class="featuredEvents__container">
                <div class="featuredEvents__content">
                    ...
                    <a class="featuredEvents__link link link--line link--blue" href="/agenda/{{ $event->season->year }}/{{ $event->slug }}">Plus d'infos<span class="sro"> sur {{ $event->title }}</span></a>
                </div>
            </div>
        </div>
        @endforeach
